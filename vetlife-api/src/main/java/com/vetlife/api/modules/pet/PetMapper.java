...
public class PetMapper {
    public Pet toEntity(PetRequest dto, Client client) {
        return Pet.builder()
                ...
                .dataNascimento(dto.dataNascimento()).photoPath(dto.photoPath()).client(client).build();
    }
    public PetResponse toResponse(Pet entity) {
        return new PetResponse(
                entity.getId(), entity.getNome(), entity.getEspecie(), entity.getRaca(),
                entity.getDataNascimento(), entity.getPhotoPath(), entity.getClient().getId(), entity.getClient().getNome()
        );
    }
}